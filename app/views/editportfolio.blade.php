   ...
   <link rel="stylesheet" href="https://cdn.rawgit.com/konpa/devicon/89f2f44ba07ea3fff7e561c2142813b278c2d6c6/devicon.min.css">
    ...
    <style>
        ...
        #slide3 {
          ...
          background-image: 
            -webkit-linear-gradient(white 2px, transparent 2px), -webkit-linear-gradient(0deg, white 2px, transparent 2px), -webkit-linear-gradient(rgba(255, 255, 255, .3) 1px, transparent 1px), -webkit-linear-gradient(0deg, rgba(255, 255, 255, .3) 1px, transparent 1px);
          background-image: 
      ...
      <div id="slide2" class="slide">
        <div class="content">
          ...
          <p class="app-block center clickable">
            ...
            <a href="http://codepen.io/denmch/pen/WvMBWQ" target="_blank">
      ...
      <div id="slide3" class="slide">
        <div class="content">
          ...
          <p class="app-block center clickable">
            ...
            <a href="http://codepen.io/denmch/pen/yNKbby" target="_blank">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-title">Programming Resume</div>
              </div>
                  <div class="modal-body">
                    <img src="/img/Resume1.png" width="100%">
                    <br>
                    <img src="/img/Resume2.png" width="100%">
                  </div>
